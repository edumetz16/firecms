...
```json
{
  ...
  "dependencies": {
    "@edumetz16/firecms_cloud": "^3.0.0-canary",
    "firebase": "^10.9.0",
    "react": "^18.3.1",
    "react-dom": "^18.3.1"
  },
...
```typescript
import {CMSView, CMSViewsBuilder, EntityCollection, EntityCollectionsBuilder, EntityCustomView, PropertyConfig} from "@edumetz16/firecms_cloud";
