...
export default defineConfig({
    ...
    resolve: {
        alias: {
            ...
            "@edumetz16/firecms_datatalk": path.resolve(__dirname, "../../packages/datatalk/src"),
            ...
            "@edumetz16/firecms_collection_editor_firebase": path.resolve(__dirname, "../../packages/collection_editor_firebase/src"),
